...
from cl.enterprise_python.core.schema.shallow.shallow_swap_key import ShallowSwapKey


class ShallowSwap(ShallowSwapKey):  # Inherits from ShallowSwapKey that has primary key attributes
